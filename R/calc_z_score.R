...
#' @param sigma standard deviation of the population.
...
#'
#' @return a statement laying out the values imputed, the subsequent z-score, p-value, and an appropriate conclusion (if p_val = TRUE, and sig_level has a value).
#' @export
#'
#' @examples
